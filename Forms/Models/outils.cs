            ...
            foreach (var file in files)
            {
                try
                {
                    ...
                    if (Regex.IsMatch(textFile, oldValue, RegexOptions.IgnoreCase))
                    {
                        ...
                        if (textFile.Contains("DataSourceServerNameForms") && file.Contains("web.config"))
                        {
                            textFile = Regex.Replace(textFile, "DataSourceServerNameForms", serverName, RegexOptions.IgnoreCase);
                        }
